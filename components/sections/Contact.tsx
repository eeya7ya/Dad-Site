            ...
            <Reveal delay={0.3}>
              <div className="mt-9">
                ...
                <ul className="space-y-2.5 text-cream/90">
                  ...
                  <li dir="ltr" className="rtl:text-right">
                    <a className="transition-colors hover:text-gold-bright" href={`tel:${studio.phone.replace(/[^\d+]/g, "")}`}>
                      {studio.phone}
                    </a>
                  </li>
                  <li dir="ltr" className="rtl:text-right text-gold">{studio.instagram}</li>
                </ul>
              </div>
            </Reveal>
          </div>
